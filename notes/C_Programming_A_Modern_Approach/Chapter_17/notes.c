...
Notice the use of free in the insert function. insert allocates memory for a
    part before checking to see if the part already exists. If it does, insert
