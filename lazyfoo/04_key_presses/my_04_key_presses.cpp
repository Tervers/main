...
enum KeyPressSurfaces   //enum named by LazyFoo to list key presses
{
	KEY_PRESS_SURFACE_DEFAULT,   //key presses named by LazyFoo
...
void close();   //probably returns nothing since it closes the application
